...
public class StudentController {
    ...
    public ResponseEntity<ExerciseDto> getNextExercise(@AuthenticationPrincipal Student student) {
        ExerciseDto exercise = studentProgressService.getNextExercise(student.getId());
